...
$(function(){
        ...
        Items: [
            { Title: "固定资产查询", Url: "/index.php/Gdzc/search", Cls: "", Icon: "", IconCls: "ico ico-query" }
        ]
    });		   
});
...
<table>
	<col width="120px" />
  <form action="/index.php/Gdzc/searchlist" method="post" name="form1">
  <thead><tr><th colspan="2">固定资产查询</th></tr></thead>
   <tr>
    <th>固定资产名称：</th>
    <td>
