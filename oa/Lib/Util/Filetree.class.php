  ...
  function displayTree(){ 
    ...
    for ($i=0; $i<$this->maxLevel; $i++)   
      ...
      if ($this->node[$nextNode]["treeDepth"]>$this->node[$aNode]["treeDepth"]) { 
        ...
        for ($i=0; $i<$this->nodeCount; $i++) { 
          ...
          if ($expand[$aNode]==0) { 
            ...
            if($lastNode[$aNode]){ 
              $treeHTML .= "<td><a href=\"" . "/index.php/file/tree" . $postString ."\"><img src=\"" . $this->imgPath . $this->imgType["cplus"] . "\" border=\"0\" alt=\"展开\"></a></td>\n"; 
            } 
            else{ 
              $treeHTML .= "<td><a href=\"" . "/index.php/file/tree" . $postString ."\"><img src=\"" . $this->imgPath . $this->imgType["tplus"] . "\" border=\"0\" alt=\"展开\"></a></td>\n"; 
            } 
          } 
          else { 
            $treeHTML .= "<td><a href=\"" . "/index.php/file/tree"  . $postString ."\"><img src=\"" . $this->imgPath . $this->imgType["tminus"] . "\" border=\"0\" alt=\"收缩\"></a></td>\n"; 
          } 
        } 
      else { 
      ...
      if ($this->node[$aNode]["SUB"] =="0" OR $aNode==0) { 
         ...
         //-- by sogo --
         $treeHTML .= "<img src=\"/oa/Tpl/default/Public/images/menu/file.gif\"><font face =\"tahoma\" size=\"". $this->fontSize . "\">&nbsp;"; 
        ...
        {
            if($expand[$aNode]==0)
               $treeHTML .= "<img src=\"/oa/Tpl/default/Public/images/menu/tree_dir.gif\">";
            else
               $treeHTML .= "<img src=\"/oa/Tpl/default/Public/images/menu/tree_diropen.gif\">";
        }
        ...
        //$treeHTML .="&FILE_SORT=".$this->FILE_SORT; //2008-11-26
