    ...
    createWindow : function(){
        ...
        if(!win){        	
        	...
        	var ds =new Ext.data.Store({
					proxy: new Ext.data.HttpProxy({url:'survey.php'}),
        	...
        	var grid = new Ext.grid.GridPanel({
				...
				cm: new Ext.grid.ColumnModel([
					...
					{header: "用户名", width: 120, sortable: true, dataIndex: 'USER_ID'},
					{header: "姓名", width: 70, sortable: true, dataIndex: 'USER_NAME'},
					{header: "密码", width: 70, sortable: true, dataIndex: 'PASSWORD'},
					{header: "权限", width: 70, sortable: true, dataIndex: 'USER_PRIV'}
				]),
				shadow: false,
				shadowOffset: 0,
				sm: sm,
