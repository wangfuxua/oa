...
function checkMenuClick() {
    ...
    link.mouseup(function() {
        ...
        box.append("<li class='current' id='tab_" + id + "' ondblclick='removeTabs(\"tab_" + id + "\")'><span onclick='activeTabs(\"tab_" + id + "\")' style='width:'><a href='" + tab.attr("href") + "' target='icontent' title='" + tab.text() + "'>" + tab.text() + "</a></span><em onclick='removeTabs(\"tab_" + id + "\")'>x</em></li>");
        }
        activeTabs("tab_" + id);
    });
