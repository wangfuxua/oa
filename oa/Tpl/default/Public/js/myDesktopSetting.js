...
var colValue = {
    id: "",
    style: "",
    desktop: [[["news", "公司新闻"], ["email", "内部邮件"]], [["Calendar", "日程安排"], ["notify", "公告通知"]], [["flow", "待办事宜"]]]
};
...
var aa = getCookie("oaDesk") || "|/news,公司新闻/email,内部邮件|/Calendar,日程安排/notify,公告通知|/flow,待办事宜/url,常用网址";
var cc = aa.split("|");
