...
$ch = $_GET['c_t'];  // 子统计条件
if(count($_GET)==1){
	open_flash_chart_object( 500, 300, 'pie_data.php?p_t='.$parent, false );
	...
	open_flash_chart_object( 500, 300, 'pie_data.php?p_t='.$parent.'&name='.urlencode($parent_cond).'&c_t='.$ch, false );
