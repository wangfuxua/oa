...
<div class='contents' style='height:300px;' id='div_contents'>连接中...</div>
		...
		while($rows = mysql_fetch_array($chat_list)){
				 echo "<tr><td><a href=\"chat_pro.php?create_room=3&room_name=".$rows['SUBJECT']."\">".$rows['SUBJECT']."</a></td></tr>";
		}
		 echo "</table>";
...
&nbsp;<a class='mybut' style='width:75px;font-size:12px;border:1px solid #666;padding:3px;' href="../chat_pro.php?create_room=1">创建会议室</a>&nbsp;<a class='mybut' style='width:75px;font-size:12px;border:1px solid #666;padding:3px;' href="../chat.php">公共聊天室</a>
</div>
