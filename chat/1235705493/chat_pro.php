...
$user=isset($_GET['password'])?$_GET['password']:'';
if($create_room=='1'){
?>
...
<?php
	...
	while ($rows=mysql_fetch_array($sql)) {
		...
		if($pw[0]!='d41d8cd98f00b204e9800998ecf8427e'){
...
<?php
		...
		while($rows = mysql_fetch_array($chat_list)){
		 echo "<tr><td><a href=\"chat.php?create_room=3&username=$user&password=$password&room_name=".$rows['SUBJECT']."\">".$rows['SUBJECT']."</a></td></tr>";
		}
