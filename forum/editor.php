...
<title>Editor</title>
<script language="javascript" src="editor/editor_base.js"></script>
<style type="text/css">
...
.icons a,.edTb,.sepline,.switch,.tbri{background-image:url(editor/editor_boolbar.gif)}
...
<!--
	function blank_load() {
		var inihtml = '';
		var obj = parent.document.getElementById('forum-ttHtmlEditor');
		if(obj) {
			inihtml = obj.value;
		}
	...
	if(document.all){
		document.write('<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" id="divEditor"><tr><td style=""><IFRAME class="HtmlEditor" ID="HtmlEditor" name="HtmlEditor" style="height:100%;width:100%" frameBorder="0" marginHeight=0 marginWidth=0 src="editor.php?op=blank&charset=utf-8" onload="blank_load();"></IFRAME></td></tr></table>');
	}else{
...
<input type="hidden" name="forum-editstatus" id="forum-editstatus" value="html">
</body>
</html>
<?php
