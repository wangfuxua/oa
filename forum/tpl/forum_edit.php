...
<div id="content">
<form method="post" action="upload.php?act=edit" enctype="multipart/form-data" onSubmit="return CheckForm();" name="upload">
...
<table>
	...
	<tr>
		...
		<input type="hidden" name="ico" value="<?=$_GET['moderator']?>">
		<td>名称：</td><td><input type="text" id="new_forum" name="new_forum" value="<?=$_GET['forumname']?>">(少于10字)</td>
	</tr>
	<tr><td valign="top">描述：</td><td><textarea id="announcement" name="announcement" cols="53" rows="6"><?=$_GET['announcement']?></textarea>(少于30字)</td></tr>
	<tr><td valign="top">排序：</td><td><input type="text" name="fieldid" value="<?=$_GET['fieldid']?>">(用于论坛在首页的排列顺序)</td></tr>
	<tr><td valign="top">选择图标：</td><td><input type="button" onclick="javascript:show();" value="点击选择系统内置图标" style="border:0px;background:#fff;color:#fc911a;">
	<img id="icoimg" name="icoimg" src="image/spacer.gif">
	<img id="previewpic" src="image/spacer.gif" onload="setpicWH(this,300,300)">
	</td></tr>
...
document.getElementById('icoimg').src="<?=$_GET['moderator']?>";
function show(){
